...
// inline constexpr const char* TAG = "MqttManager";
...
public:
    ...
    void init() {
        ...
        // strncpy((char*)mqtt_cfg.uri, CONFIG_MQTT_BROKER_URI, sizeof(mqtt_cfg.uri));

        client = esp_mqtt_client_init(&mqtt_cfg);
        esp_mqtt_client_register_event(client, MQTT_EVENT_ANY, &MqttManager::mqtt_event_handler, this);
        esp_mqtt_client_start(client);

        ESP_LOGI(TAG, "MqttManager successfully initialized.");
    }
